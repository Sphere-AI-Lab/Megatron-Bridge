#!/bin/bash
# Single-GPU LoRA finetuning of Llama 3.2 1B (no SLURM)
#
# Usage:
#   bash run_lora_finetune.sh
#
...
echo "Starting LoRA finetuning with ${NUM_GPUS} GPU(s)..."
torchrun --nproc_per_node="${NUM_GPUS}" \
    tutorials/recipes/llama/01_quickstart_finetune_lora.py \
