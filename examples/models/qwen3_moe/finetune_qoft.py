...
def transform_sharded_state_dict_for_fp8(*args, **kwargs):
    from megatron.bridge.peft.fp8_utils import transform_sharded_state_dict_for_fp8 as _impl

    return _impl(*args, **kwargs)


def register_fp8_scale_inv_buffers_after_load(*args, **kwargs):
    from megatron.bridge.peft.fp8_utils import register_fp8_scale_inv_buffers_after_load as _impl
