...
Files copied/adapted from:
    - transformer_engine/pytorch/module/layernorm_linear.py
      ...
      Verified against TransformerEngine v2.14 (f031cf87)
    ...
    - megatron/core/extensions/transformer_engine.py
      ...
      Verified against Megatron-Core 235952df
"""

# The guarded import block below mirrors the import list of the upstream files
# this module was copied from, so that it stays diffable against TE v2.14 on a
# version bump. Several symbols are consequently unused here; keep them.
# ruff: noqa: F401
...
try:
    ...
    # Raise rather than exit(1): oft.py loads this module via safe_import_from,
    # which swallows ImportError and falls back to the unfused OFT path. A
    # RuntimeError here is normalized to ImportError because safe_import_from
    # re-raises anything else.
    raise ImportError(f"TEOFTLayerNormColumnParallelLinear requires Transformer Engine: {e}") from e
