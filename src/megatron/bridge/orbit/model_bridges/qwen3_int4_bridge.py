...
class Qwen3INT4Bridge(CompressedTensorsINT4DequantMixin, Qwen3Bridge):
    """Dense Qwen3 bridge that preserves compressed-tensors INT4 direct writes."""


class Qwen3MoEINT4Bridge(CompressedTensorsINT4DequantMixin, Qwen3MoEOrbitProviderMixin, Qwen3MoEBridge):
