...
Orbit-owned variant of mcore's ``to_empty_if_meta_device``: identical
semantics, plus unwrapping of ModelOpt ``QTensorWrapper`` tensors during
materialization. ModelOpt's ``RealQuantLinear._apply()`` re-wraps its
